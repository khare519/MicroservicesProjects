...
@Tag(
        name="CRUD operations on Accounts Microservices",
        description = "This APIs helps us to perform operations like create,read,update and delete"
)
@RestController
...
public class AccountsController
{
    ...
    @Operation(
            ...
            description="REST API to get customer and its account details"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    {
        CustomerDto customerDetails = accountsService.getCustomerDetails(mobileNumber);
    ...
    public ResponseEntity<String> buildInfo() throws TimeoutException {
        logger.debug("Request Reached");
        return ResponseEntity.status(HttpStatus.OK).body(buildVersion);
  }
    public ResponseEntity<String> buildInfoFallback(Throwable throwable){
        logger.debug("buildInfoFallback method called");
