...
@Validated
@Tag(
        name="Loans microservice to perform CRUD operation",
        description = "This microservices perform creating,reading,updating and deleting of loans details"
)
public class LoansController
{
    ...
    @Operation(
            ...
            description = "This microservice creates a new loan for the given mobile number")
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
   ...
   @PostMapping("/create")
    public ResponseEntity<ResponseDto> createLoan(@RequestParam @Pattern(regexp = "^[0-9]{10}$",message = "Mobile number should be of 10 digits") String mobileNumber){
   ...
   @GetMapping("/fetch")
    public ResponseEntity<LoansDto> fetchLoan(@RequestHeader("eazybank-correlation-id")String correlationId,@RequestParam @Pattern(regexp = "^[0-9]{10}$",message = "Mobile number should be of 10 digits") String mobileNumber){
        logger.debug("fetchLoan method start");
        LoansDto loan=loansService.fetchLoanDetails(mobileNumber);
    ...
    public ResponseEntity<ResponseDto> updateLoanDetails(@Valid @RequestBody LoansDto loansDto){
      boolean isLoanUpdated= loansService.updateLoanDetails(loansDto);
      if(isLoanUpdated){
